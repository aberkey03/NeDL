        ...
        //if the option is U or u then update a name in the array (if it is there)
            else if (userChoiceString=="U" || userChoiceString=="u")
            {
                ...
                do
                {
                    ...
                    for (index =0;index<10;index++)
                    {
                        if (nameArray[index]==currentName)
                        {
                            Console.WriteLine($"{currentName} is at postion {index}. Enter the new name.");
                            newName=Console.ReadLine();
                            //update name in array
                            nameArray[index]=newName;
                            Console.WriteLine($"{currentName} has been updated to " + nameArray[index] + $" at position {index}.");
                        }
                        nameFound=true;
                    }
                    if (nameFound==false)
